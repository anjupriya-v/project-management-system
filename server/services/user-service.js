          ...
          if (error) {
            ...
            projectModel
              .updateMany(
                ...
                {
                  $set: {
                    "teamMembers.$[item].fullName": userDetails.fullName,
                    "teamMembers.$[item].phoneNumber": userDetails.phoneNumber,
                    "teamMembers.$[item].profileImage": imagePath,
                  },
                },
                {
                  arrayFilters: [
              ...
              .then((result, error) => {
                if (error) {
                  if (error) {
                    reject({
                      status: false,
                      msg: "Unable to update the team Member details in all projects",
                    });
                  } else {
                    resolve({
                      status: true,
                      msg: "Team Members details is updated successfully in all projects!",
                    });
                  }
                }
              })
            ...
            projectModel
              .updateMany(
                ...
                {
                  $set: {
                    "teamMembers.$[item].role": userDetails.role,
                  },
                },
                {
                  arrayFilters: [
